...
{
    [Table(Names.Tables.Learjet.ProofReads.Equipment, Schema = Names.Tables.Learjet.ProofReads.Schema)]
    public class LearjetProofReadEquipment : ProofReadEntryBase
    {
        ...
        public static LearjetProofReadEquipment Compare(LearjetProofEquipment proof, LearjetEquipment entry)
        {
            LearjetProofReadEquipment item = new LearjetProofReadEquipment();
