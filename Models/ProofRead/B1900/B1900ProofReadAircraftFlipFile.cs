...
{
    [Table(Names.Tables.B1900.ProofReads.AircraftFlipFile, Schema = Names.Tables.B1900.ProofReads.Schema)]
    public class B1900ProofReadAircraftFlipFile : ProofReadEntryBase
    {
        ...
        public static B1900ProofReadAircraftFlipFile Compare(B1900ProofAircraftFlipFile proof, B1900AircraftFlipFile entry)
        {
            B1900ProofReadAircraftFlipFile item = new B1900ProofReadAircraftFlipFile();
