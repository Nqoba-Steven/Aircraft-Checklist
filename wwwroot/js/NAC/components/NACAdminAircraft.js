        ...
        <div id="container" class="container">
            ...
            <div class="hidden" id="addForm">
                ...
                <form>
                    ...
                    <input required id="aircraftReg" type="text" name="aircraftReg"  />
                    ...
                    <lable>Base</lable>
                    <input required id="aircraftBase" type="text" name="aircraftBase"  />
                </form>
    ...
    connectedCallback() {
        ...
        this.buildPayload();
            var isNull =
                ...
                ||
                this.aircraftPayload.EmailAddress == null
                ||
                this.aircraftPayload.BaseOfOperations == null;

            if (isNull) {
                console.log('Empty field')
                this.showError("Please fill in all field");
                return;
            }
            var isNotValid =
                this.aircraftPayload.Reg.length <= 0
                ||
                this.aircraftPayload.Type.length <= 0
                ||
                this.aircraftPayload.BaseOfOperations.length <= 0
                ||
                this.aircraftPayload.EmailAddress.length <= 0;
            if (isNotValid) {
                this.showError("Please fill in all field");
                return;
            }
